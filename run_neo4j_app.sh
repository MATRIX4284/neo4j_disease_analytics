...
docker run -it --rm   --publish=7474:7474 --publish=7687:7687   --user="$(id -u):$(id -g)" -v $HOME/neo4j/import:/var/lib/neo4j/import  -e NEO4J_AUTH=none   --env NEO4JLABS_PLUGINS='["apoc","graph-data-science"]'   neo4j:5.2.0
